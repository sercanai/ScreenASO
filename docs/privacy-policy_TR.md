...
Açık kaynaklı bir proje olarak Screen ASO şeffaf bir şekilde geliştirilir ve topluluk katkıları memnuniyetle karşılanır. Kaynak kodu depomuzda incelemeye açıktır.
...
- **Telemetri yok:** Araç herhangi bir kullanım istatistiği, çökme raporu veya telemetri verisi toplamaz. Tüm işlemler makinenizde yerel olarak gerçekleşir.
...
- Kaynak kodu depomuzda incelemeye açıktır.
- Yerel verilerinizin nasıl kullanıldığına dair sorular için lütfen GitHub depomuzda bir issue açın.
...
## 8. Açık Kaynak ve Topluluk

Screen ASO, MIT Lisansı altında lisanslanmış açık kaynaklı bir projedir. Topluluk katkıları memnuniyetle karşılanır ve teşvik edilir. Katkıda bulunma hakkında bilgi için lütfen depomuzdaki CONTRIBUTING.md dosyasına bakın.

## 9. Bu Politikanın Değişmesi

Araçta yapılan değişiklikleri yansıtmak için bu politikayı güncelleyebiliriz. Mümkün oldukça yeni sürümleri versiyonlayacağız ve bu belgeyi güncelleyerek en üstteki tarihi ifade edeceğiz. Bu politikadaki tüm değişiklikler herkese açık depomuz üzerinden şeffaf bir şekilde yapılacaktır.

## 10. İletişim

Bu gizlilik politikasıyla ilgili sorular için lütfen:
- GitHub depomuzda bir issue açın
- GitHub Discussions'da bir tartışma başlatın
- Teknik detaylar için kaynak kodumuzu inceleyin
